        ...
        <>
            <section className='text-center h-screen flex flex-col items-center justify-center bg-white text-black'>
                ...
                <div className='flex gap-4 mt-6'>
                    <button className='bg-blue-600 text-white px-4 py-2 rounded border border-blue-600 cursor-pointer hover:scale-105 transition'>Get Started</button>
                    <button className=' text-black px-4 py-2 rounded border  cursor-pointer hover:scale-105 transition'>Watch Demo</button>
                </div>
            </section>
