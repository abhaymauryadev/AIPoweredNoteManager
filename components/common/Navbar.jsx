...
export default function Navbar() {
  ...
  return (
    <nav className="w-full h-16 border-b border-gray-300 bg-white shadow-sm fixed top-0 left-0 right-0 z-50 dark:bg-gray-800 dark:border-gray-700 ">
      <div className="flex justify-between items-center h-16 px-4 sm:px-6 lg:px-8 w-full max-w-7xl mx-auto dark:text-white">

        {/* Logo */}
        <div className="flex items-center">
          <Link href="/" className="flex items-center gap-2">
            <Image src="/favicon.ico" alt="Logo" width={32} height={32} className="w-8 h-8" />
            <span className="font-bold text-lg text-gray-800 dark:text-white">AI Notes Manager</span>
          </Link>
        </div>

        {/* Desktop Navigation Links */}
        <div className="hidden md:flex gap-8 items-center text-gray-700 dark:text-white">
          <Link href="#features"  className=" hover:text-blue-600 transition font-medium">
            Features
          </Link>
          <Link href="/pricing" className=" hover:text-blue-600 transition font-medium">
            Pricing
          </Link>
        ...
        <div className="hidden md:flex gap-4 items-center text-gray-700 dark:text-white">
          <button onClick={() => router.push("/auth/login")} className=" hover:text-blue-600 transition font-medium cursor-pointer">
            Sign In
          </button>
