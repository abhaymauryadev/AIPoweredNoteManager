...
export const metadata = {
  ...
  keywords: [
    ...
    // Mid-tail keywords
    "AI note manager",
    "AI-powered notebook manager",
    "smart notebook organizer",
    "note taking app for students",
    "note app for teams",
    "AI note search tool",
    "cloud based notebook app",
    "note organization software",
    "collaborative note taking app",
    "productivity notebook tool",
    ...
    "AI note taking app for teams and professionals",
    "smart note organizer with AI powered search",
    "note management app built with Next.js and AI",
    "best AI notebook app for students and professionals",
    "organize and search notes using artificial intelligence",
    "AI driven note management system for productivity",
    "note taking tool with AI powered organization features",
  ],
